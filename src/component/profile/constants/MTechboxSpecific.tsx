...
export const MTechBoxSpecific = [
    {borderColor: "border-rose-600", content:
            <>
                <p className={"text-xl font-bold"}>{'Frontend/App'}</p>
                ...
                <p className={"text-xs text-center"}>
                    {'애플리케이션의 경우'}
                    <br/>{'React-Native를 선호하며'}
                    <br/>{'기본적으로 Typescript를'}
                    <br/>{'사용하여 개발합니다'}
                    <br/>{'필요한 경우 Kotlin, Swift'}
                    <br/>{'Objective-C 언어를 사용하여'}
    ...
    {borderColor: "border-blue-600", content:
            <>
                ...
                <p className={"text-xs text-center"}>
                    {'서버의 경우 Typescript 또는'}
                    <br/>{'Kotlin 언어를 선호하며,'}
                    <br/>{'빠른 속도의 개발이 필요할 때에는'}
                    <br/>{'Express 프레임워크를,'}
                    <br/>{'안정적인 서버가 요구되거나 큰 프로젝트에는'}
                    <br/>{'NestJS/Spring Boot'}
                    <br/>{'프레임워크를 선호합니다.'}
                </p>
                <p className={"text-xs text-center"}>
    ...
    {borderColor: "border-purple-600", content:
            <>
                <p className={"text-xl font-bold"}>{'Principle'}</p>
                <div>
